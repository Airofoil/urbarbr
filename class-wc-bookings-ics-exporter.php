	...
	protected function generate() {
		...
		foreach ( $this->bookings as $booking ) {
			...
			if($booking->get_order()){
				$location = '';
				$location .= $booking->get_order()->get_billing_address_1() . ' '.$booking->get_order()->get_billing_address_2(). ' ';
				$location .= $booking->get_order()->get_billing_city(). ' ';
				$location .= $booking->get_order()->get_billing_state(). ' ';
				$location .= $booking->get_order()->get_billing_postcode(). ' ';
				$location .= $booking->get_order()->get_billing_country(). ' ';
				$location .= $this->eol;
			}else{
				$location = $this->eol;
			}
