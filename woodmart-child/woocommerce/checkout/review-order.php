...
foreach(WC()->cart->get_cart() as $cart_item_key => $item_values){
	...
	$barber_name = $item_values['booking']['type'];
	$booking_services = $item_values['addons'];
}
...
<table class="shop_table woocommerce-checkout-review-order-table">
	<thead>
		<tr>
			<th class="product-name"><?php esc_html_e( $barber_name , 'woocommerce' ); ?></th>
					...
					foreach($booking_services as $booking_service) {
						...
						<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
							<td class="product-name">
								<?php echo $booking_service['value']; ?>
							</td>
							<td class="product-total">
								<?php echo wc_price($booking_service['price']); ?>
							</td>
						</tr>
						<?php
					}
